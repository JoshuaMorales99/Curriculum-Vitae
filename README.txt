...
Realizar una pagina web que posea un curriculum vitae. La creación
de este CV online permitirá llevar a la práctica todo lo que se
fue trabajando a lo largo de los módulos. El CV comprende
...
Como no es necesario que se incluya información personal propia,
se propone usar una web de la cual se podrá obtener datos
personales de personas ficticias.

Una vez que se tenga la información deseada, se pasará a utilizar
HTML y CSS para darle estructura y estilo al proyecto. Finalmente,
se propone incorporar funcionalidades que implementen JavaScript,
